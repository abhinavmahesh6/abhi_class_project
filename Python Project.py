...
def Getinputs():        
    ...
    while tempvar==1:
        ...
        for inp1 in range(0,_NoAdults):
            ...
            travelid1=p[travelidvar]
            travelidvar+=1
            list1=[name1,passno1,gender1,age1,travelid1,meal1]
            query3="insert into Cust_info values('%s','%s','%s','%s','%s','%s','%s')"%(name1,passno1,gender1,age1,travelid1,meal1,InpPlane_ID)
        ...
        for inp2 in range(0,_NoChildren):
            ...
            travelid2=p[travelidvar]
            travelidvar+=1
            list2=[name2,passno2,gender2,age2,travelid2,meal2]
            query4="insert into Cust_info values('%s','%s','%s','%s','%s','%s','%s')"%(name2,passno2,gender2,age2,travelid2,meal2,InpPlane_ID)
        ...
        for inp3 in range(0,_NoInfants):
            ...
            travelid3=p[travelidvar]
            travelidvar+=1
            query5="insert into Cust_info values('%s','%s','%s','%s','%s','%s','%s')"%(name3,passno3,gender3,age3,travelid3,meal3,InpPlane_ID)
